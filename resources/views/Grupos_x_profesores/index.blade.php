...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="grupos_x_profesores/create" class="btn btn-primary btn-block" align="center">Crear un nuevo grupo por profesor</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td align="center">
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/grupos_x_profesores/'.$grupo_x_profesor->id]) !!}
                    <a href="{!! 'grupos_x_profesores/'.$grupo_x_profesor->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'grupos_x_profesores/'.$grupo_x_profesor->id.'/edit' !!}" class="btn btn-warning">

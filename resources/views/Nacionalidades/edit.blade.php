...
<br />
<br />
<h1 align="center">Editar nacionalidad: {!! $nacionalidad->nombre !!}.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['method'=>'PATCH', 'url'=>'/nacionalidades/'.$nacionalidad->id, 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('nombre', 'Nombre de la nacionalidad',['class'=>'text-success miest']) !!}
        {!! Form::text ('nombre',$nacionalidad->nombre,['placeholder'=>'Ingresa el nombre de la nacionalidad', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('id_pais', 'Nombre de pais',['class'=>'text-success miest']) !!}
        <br />
        {!! Form::select ('id_pais',$paises->pluck('nombre','id')->all(), $nacionalidad->id_pais, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />

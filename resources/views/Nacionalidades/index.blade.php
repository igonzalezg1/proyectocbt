...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            <h1 align="center">Listado de nacionalidades</h1>
        </div>
        <div class="col-sm-2"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="nacionalidades/create" class="btn btn-primary btn-block" align="center">Crear una nueva nacionalidad</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td>{!! $nacionalidad->paises->nombre !!}</td>
                    <td align="center">
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/nacionalidades/'.$nacionalidad->id]) !!}
                    <a href="{!! 'nacionalidades/'.$nacionalidad->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'nacionalidades/'.$nacionalidad->id.'/edit' !!}" class="btn btn-warning">

...
<script>
    function validar(){
        ...
        if(id_profesor.value == "" || /^\s+$/.test(id_profesor.value) || clave.value.length > 50){
            alert("El profesor debe ser menor a 5 caracteres");
...
<br />
<br />
<h1 align="center">Asignar grupo a profesor.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['url'=>'/grupos_x_profesoress', 'onsubmit'=>'return validar();']) !!}
    ...
    <div class="form-group">
        ...
        <br />
        {!! Form::select ('id_profesor',$profesores->pluck('nombres','id')->all(), null, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <br />
        {!! Form::submit ('Guardar grupo por profesor',['class'=>'btn btn-success w-100']) !!}
    </div>
{!! Form::close() !!}
    </div>
</div>

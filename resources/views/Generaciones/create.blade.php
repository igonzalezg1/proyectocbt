...
<br />
<br />
<h1 align="center">Crear una nueva generacion.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['url'=>'/generaciones', 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('nombre', 'Nombre de la generacion',['class'=>'text-success miest']) !!}
        {!! Form::text ('nombre',null,['placeholder'=>'Ingresa el nombre de la generacion', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('anio_inicio', 'Año de inicio',['class'=>'text-success miest']) !!}
        {!! Form::number ('anio_inicio',null,['placeholder'=>'Ingresa el año de inicio', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('anio_fin', 'Año de fin',['class'=>'text-success miest']) !!}
        {!! Form::number ('anio_fin',null,['placeholder'=>'Ingresa el nombre año de fin', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <br />
        {!! Form::submit ('Guardar generacion',['class'=>'btn btn-success btn-block']) !!}
    </div>
{!! Form::close() !!}
    </div>
</div>

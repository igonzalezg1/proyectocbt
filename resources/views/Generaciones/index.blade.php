...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="generaciones/create" class="btn btn-primary btn-block" align="center">Crear una nueva generacion</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td align="center">
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/generaciones/'.$generacion->id]) !!}
                    <a href="{!! 'generaciones/'.$generacion->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'generaciones/'.$generacion->id.'/edit' !!}" class="btn btn-warning">

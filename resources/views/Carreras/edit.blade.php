...
<br />
<br />
<h1 align="center">Editar carrera {!! $carrera->nombre !!}.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['method'=>'PATCH', 'url'=>'/carreras/'.$carrera->id, 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('nombre', 'Nombre de la carrera',['class'=>'text-success miest']) !!}
        {!! Form::text ('nombre',$carrera->nombre,['placeholder'=>'Ingresa el nombre de la carrera', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('clave', 'Clave de la carrera',['class'=>'text-success miest']) !!}
        {!! Form::text ('clave',$carrera->clave,['placeholder'=>'Ingresa la clave de la carrera', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('status', 'Estatus de la carrera',['class'=>'text-success miest']) !!}
        <br />
        {!! Form::select ('status', array('1'=>'Activo', '0'=>'Inactivo'), $carrera->status, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />

...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            <h1 align="center">Listado de carreras</h1>
        </div>
        <div class="col-sm-2"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="carreras/create" class="btn btn-primary btn-block" align="center">Crear una nueva carrera</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td>{!! $pais->status !!}</td>
                    <td align="center">
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/carreras/'.$pais->id]) !!}
                    <a href="{!! 'carreras/'.$pais->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'carreras/'.$pais->id.'/edit' !!}" class="btn btn-warning">

...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            <h1 align="center">Listado de generaciones</h1>
        </div>
        <div class="col-sm-2"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="generacioness/create" class="btn btn-primary w-100" align="center">Crear una nueva generacion</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td align="center">
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/generacioness/'.$generacion->id]) !!}
                    <a href="{!! 'generacioness/'.$generacion->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'generacioness/'.$generacion->id.'/edit' !!}" class="btn btn-warning">

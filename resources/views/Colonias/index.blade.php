...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            <h1 align="center">Listado de colonias</h1>
        </div>
        <div class="col-sm-2"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="colonias/create" class="btn btn-primary btn-block" align="center">Crear una nueva colonia</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td>{!! $colonia->tipo_asentamiento !!}</td>
                    <td>{!! $colonia->cp !!}</td>
                    <td>{!! $colonia->municipios->nombre !!}</td>
                    <td align="center">
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/colonias/'.$colonia->id]) !!}
                    <a href="{!! 'colonias/'.$colonia->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'colonias/'.$colonia->id.'/edit' !!}" class="btn btn-warning">

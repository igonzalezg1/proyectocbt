...
<script>
	function buscar_matricula(matricula_alumno_b)
	{
		$("#DataResult").empty();
		var asset = '{!! asset('') !!}';
		var ruta = asset+'buscar_x_matricula/'+matricula_alumno_b;
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-8">
			<h2 align="center" class="text-success">Buscar alumno por matricula</h2>
		</div>
		<div class="col-sm-2"></div>
	</div>
	<div class="row">
		...
		<div class="col-sm-4">
			<div class="form-inline">
				<label for="matricula_alumno_b" class="text-success miest sr-only">Ingresa la matricula a buscar</label>
				<div class="input-group">
					<br />
					<input type="text" name="matricula_alumno_b" id="matricula_alumno_b" class="form-control mb-2 mr-sm-2" placeholder="Ingresa la matricula" onkeyup='javascript:this.value = this.value.toUpperCase();'>
					<a class="btn btn-primary mb-2" onclick="buscar_matricula(matricula_alumno_b.value);"><i class="bi bi-search"></i></a>
				</div>
			</div>
		</div>
		<div class="col-sm-4"></div>

...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h1 class="text-success" align="center">Reporte del grupo {!! $grupo->nombre !!}</h1>
            </div>
            <div class="col-sm-4">
                <h5>Fecha: {!! $date !!}</h5>
                <h6>Total de hombres: {!! $hombres !!}</h6>
                <h6>Total de mujeres: {!! $mujeres !!}</h6>
            </div>
        </div>
    </div>
            <div class="col-sm-12">
                ...
                <table class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{!! $datas->ap_paterno !!} {!! $datas->ap_meterno !!} {!! $datas->nombres !!}</td>

...
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['url'=>'/register', 'onsubmit'=>'return validar();']) !!}
    {{ csrf_field() }}
    ...
    <div class="form-group">
        ...
        <br />
        {!! Form::select ('id_tipo_user', array('2'=>'Orientador', '3'=>'Secretarios'), null, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">

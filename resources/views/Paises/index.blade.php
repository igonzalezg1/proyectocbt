...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            <h1 align="center">Listado de paises</h1>
        </div>
        <div class="col-sm-2"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="paises/create" class="btn btn-primary btn-block" align="center">Crear un nuevo pais</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <a href="{!! 'paises/'.$pais->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'paises/'.$pais->id.'/edit' !!}" class="btn btn-warning">

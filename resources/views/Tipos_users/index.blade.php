...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            <h1 align="center">Listado de tipos de usuarios</h1>
        </div>
        <div class="col-sm-2"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="tipos_users/create" class="btn btn-primary btn-block" align="center">Crear un nuevo tipo de usuario</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                @foreach($tipos_users as $tipo_user)
                <tr>
                    <td>{!! $tipo_user->id !!}</td>
                    <td>{!! $tipo_user->nombre !!}</td>
                    <td>{!! $tipo_user->status !!}</td>
                    <td align="center">
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/tipos_users/'.$tipo_user->id]) !!}
                    <a href="{!! 'tipos_users/'.$tipo_user->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'tipos_users/'.$tipo_user->id.'/edit' !!}" class="btn btn-warning">
